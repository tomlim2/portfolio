...
기존 자료에 없는 역할·성과·수치를 만들어 채우지 않는다. VR·모션·브랜딩은 내용에 맞는 설명 구조를 사용한다. 브랜딩 작업에 기술 최적화 수치가 꼭 필요한 것은 아니다. 기존 원본을 꺼내는 방법은 [이식 기록](portfolio-migration.md#원본-확인과-복구)을 참고한다.
...
5. 기존 URL이 있다면 해당 URL의 리다이렉트 페이지도 공개 목록에 추가한다. 이식 진행 상태를 [체크리스트](portfolio-migration.md)에 반영한다.
