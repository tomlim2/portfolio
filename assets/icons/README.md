...
The only active custom cursor is download = download, with a centered 20px symbol and a 12 12 click hotspot. Other cursor files are retained legacy assets; links and actions use the native pointer.
